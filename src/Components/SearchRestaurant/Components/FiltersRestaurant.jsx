...
export default function Filters_Restaurant({stateSection,state,setState,filterOrdersExists ,setFilterOrdersExists}){
    return (
        <>
        <section className={`filtersRestaurant duration-300 ${state && stateSection === 2? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'} flex gap-12  flex-col pt-[17px] z-[90] absolute top-0 left-0 w-full h-screen`}>
